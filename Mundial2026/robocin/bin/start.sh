...
echo "*************************************************************************"
echo "*************************************************************************"
echo " This program uses implementations from CYRUS Soccer Simulation 2D Team"
echo " CYRUS Open Source: https://github.com/Cyrus2D/cyrus-soccer-simulation-team"
echo " Copyright 2013-2025 CYRUS 2D Soccer Simulation Team"
