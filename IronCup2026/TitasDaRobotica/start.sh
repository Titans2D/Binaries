...
echo "******************************************************************"
echo "*************************************************************************"
echo " This program is modified by TitasDaRobotica"
echo " Copyright 2025, Gabriel Garcia Tissianel, Ghabriel Borges Campi, Henrique Frisso Oliveira, João Mattedi Cetto"
echo " Titãs Da Robótica - Instituto Federal do Espírito Santo, Brazil"
